...
#     temperature_params_ranges = {i:{'alphaw':(0.1,1.0), 'kh':(1.0,200.0)} for i in rews}
    ...
    # # FOR ELDER CREEK: Linear into nonlinear reservoir, preferential rock moisture vadose zone
    parameter_group_params = {i:{'zrS': 100.0, 'zrR': 1000.10, 'alpha':0.1431, 'res2': 1.0, 'res1': 1.0, 'gz': LinearToNonlinearReservoir , 'nR': 0.4, 'b': 2.167, 'stS': 0.3, 'storageS': 1.0, 'nS': 0.458, 'a': 0.00277, 'k12': 0.4235, 'storageR': 100.0, 'f': 0.6313, 's0R': 0.052, 's0S': 0.2686, 'k1': 0.1952, 'stR': 0.6343, 'vz': PreferentialRockMoistureZone } for i in parameter_groups}          
