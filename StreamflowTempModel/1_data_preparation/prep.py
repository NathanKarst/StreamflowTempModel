...
#     temperature_params_ranges = {i:{'alphaw':(0.1,1.0), 'kh':(1.0,200.0)} for i in rews}
    ...
    # # FOR ELDER CREEK: Linear into nonlinear reservoir, preferential rock moisture vadose zone
    parameter_group_params = {i:{'zrS': 100.0, 'zrR': 827.8, 'alpha':0.720, 'res2': 1.0, 'res1': 1.0, 'gz': LinearToNonlinearReservoir , 'nR': 0.1139, 'b': 2.167, 'stS': 0.65, 'storageS': 1.0, 'nS': 0.45, 'a': 0.00298, 'k12': 0.498, 'storageR': 100.0, 'f': 0.793, 's0R': 0.0128, 's0S': 0.19, 'k1': 0.209, 'stR': 0.141, 'vz': PreferentialRockMoistureZone } for i in parameter_groups}          
