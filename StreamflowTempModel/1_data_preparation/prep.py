...
#     temperature_params_ranges = {i:{'alphaw':(0.1,1.0), 'kh':(1.0,200.0)} for i in rews}
    ...
    parameter_ranges = {i:{'alpha':(.05,0.5),'nR':(0.01,0.4),'nS':(0.05,0.6),'f':(.1,.9),'s0R':(0,.4),'k12':(.05,.5),'k1':(.05,.5),'s0S':(0,.4),'stR':(0.1,0.9),'stS':(0.2,0.9), 'b':(2.0,2.5)} for i in parameter_groups}
