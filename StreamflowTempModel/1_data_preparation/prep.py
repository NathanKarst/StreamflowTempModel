...
#     temperature_params_ranges = {i:{'alphaw':(0.1,1.0), 'kh':(1.0,200.0)} for i in rews}
    ...
    # # FOR ELDER CREEK: Linear into nonlinear reservoir, preferential rock moisture vadose zone
    parameter_group_params = {i:{'zrS': 100.0, 'zrR': 628.10, 'alpha':0.168, 'res2': 1.0, 'res1': 1.0, 'gz': LinearToNonlinearReservoir , 'nR': 0.092, 'b': 2.32, 'stS': 0.65, 'storageS': 1.0, 'nS': 0.45, 'a': 0.00159, 'k12': 0.444, 'storageR': 100.0, 'f': 0.103, 's0R': 0.287, 's0S': 0.19, 'k1': 0.218, 'stR': 0.758, 'vz': PreferentialRockMoistureZone } for i in parameter_groups}          
